...
public class Exam2 {
    public static void main(String[] args) {
        ...
        String str2 = "hello"; // 기초타입을 쓰는 경우 hello가 있는지 확인 있음
                               // str1, str2 -> hello
        ...
        // 이후 동일한 데이터로 다시 선언하면 그 데이터를 가지는 객체가 이미 있는지
        // 확인한 후 있으면.. 그 메모리 그대로 이용(Sring은 불변이기에), 없으면 생성..
        ...
        // 대소문자 무시
        System.out.println(str.equalsIgnoreCase("hello world")); // true ( 대소문자 무시)
