...
public class Exam1 {
    public static void main(String[] args){
        ...
        // 배열변수는 꼭 사이즈로 초기화(메모리 확보)하고 사용해야함
        // 배열의 사이즈는 불변!!
        // 배열 변수에 저장된 것은 실제 데이터가 아니라.. 확보한 메모리를 지칭하는 주소값!!
        // 따라서 배열 변수는 주소값을 가지는 변수를 reference 변수
        int[] scores = new int[5];
        int scores1[] = new int[5];

        System.out.println("primitive type : " + score); // primitive type : 30
        System.out.println("reference type : " + scores); // reference type : [I@6d03e736
        ...
        //	at ch2.section3.Exam1.main(Exam1.java:27)
        // 배열의 사이즈를 벗어난 index를 지칭했을때의 에러...
        //
//        scores[5] = 10; // error
