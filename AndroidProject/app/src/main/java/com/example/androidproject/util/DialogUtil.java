...
public class DialogUtil {
    ...
    // 여러 곳에서 사용하는 코드의 중복을 핗기 위해서 이곳에 담아놓고... 필요한 곳에서 호출해서 쓰겠다는 의도...
    // 그 함수를 object member로 만들 필요가 있을까?? 보통의 경우 static memeber로...
    public static void showToast(Context context,String message){
        Toast.makeText(context, message, Toast.LENGTH_SHORT).show();
    }

    // 어디선가.. custom dialog 가 떠야하는 순간 호출...
    ...
    // 메시지를 뿌리는 그리고 ok, cancel 버튼을 가진 dialog를 띄우는 함수..
    // 이곳에서 띄운다... ok, cancle 버튼 클릭시 이벤트 처리는 이곳에서 한다..
    // 띄우는 곳마다 이벤트 처리가 다를 것이다...
    // 이곳에서 이벤트 발생시.. 띄우는 곳에서 지정한 callback만 호출해 준다...
