...
public class ScoreAddActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v == binding.keyAdd){
            // DetailActivity에 의해 이 액티비티가 실행되었을 것이다...
            // DetailActivity가 전달해준.. 학생 id값을 추출한다..
            ...
            // 화면은 어떻게 처리....?
            // CRUD의 create 화면이다.. 목록 화면으로 자동 전환.. DetailActivity.. 데이터 넘기면서..
            ...
            // 나머지 숫자 키...
            // 버튼의 문자열이 숫자이다..
            // 이벤트가 발생한 문자열을 추출해서.. 입력하는 숫자로 사용..
            ...
            String score = binding.keyEdit.getText().toString();
            if(score.equals("0")){
                // 현재 화면에 0이 찍혀있다면... 유저가 클릭한 문자열을 그대로 출력...
