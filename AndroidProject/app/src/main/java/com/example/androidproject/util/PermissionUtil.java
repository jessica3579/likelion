...
public class PermissionUtil {
    public static void checkAllPermission(ComponentActivity activity, PermissionCallback callback){
        ...
        // 하나의 퍼미션을 유저에게 요청하는 경우에는 Request Permission
        // 한번에 여러번 퍼미션 조정을 요청한다면.. RequestMultiplePermissions
        ActivityResultLauncher<String[]> launcher = activity.registerForActivityResult(
                new ActivityResultContracts.RequestMultiplePermissions(),
                // RequestPermission이면 result - boolean
                // RequestMultiplePermission의 result - Map<String, boolean> : 퍼미션 문자열
                result -> {
